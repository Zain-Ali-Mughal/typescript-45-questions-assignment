...
let currentUsers: string[] = ["zain", "admin", "kashif", "asif", "asim"];
let newUsers: string[] = ["zain", "FARHAN", "osama", "kashif", "sami"];
...
for (let newUser of newUsers) {
  ...
  if (currentUsersLowercase.includes(newUser.toLowerCase())) {
    console.log(
      `The username '${newUser}' is already taken. Please enter a new username.`
    );
  } else {
