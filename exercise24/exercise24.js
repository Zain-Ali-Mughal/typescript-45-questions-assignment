...
console.log(fruits.includes("apple")); // True  //i will use include method for that it will checkif element is in the array.
console.log("Is 'mango' in fruits? I predict False.");
console.log(fruits.includes("mango")); // False
// Test whether an item is not in an array
console.log("Is 'mango' not in fruits? I predict True.");
console.log(!fruits.includes("mango")); // True // for ont i will add "!" symbol at the front of inclue command.
